INSERT INTO public.quiztest_question(
	...
	VALUES (31,0,'Who won the Netball World Cup in 2023?', 2, 1);

INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (32,0,'Which sport uses the terms “spike”, “ace” and “libero”? ', 2, 1);

INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (33,0,'Which of the following leagues has Faf de Klerk played in?', 3, 1);

INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (34,0,'How many players are there in a cricket team? ', 1, 1);

INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (35,1,'As of May 2024, Javier Sotomayor holds the world record for high jump.', 2, 1);
...
INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (37,0,'What is the highest score you can receive in bowling? ', 2, 1);

INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (38,0,'Which of the following is not an official swimming stroke? ', 1, 1);
...
INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (55,0,'In which city will the 2024 Summer Olympics be held?', 2, 1);

INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (56,1,'A basketball game is 48 minutes in total.', 1, 1);

INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (57,1,'Baba Watson is a right hand golf player.', 3, 1);

INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (58,1,'Karate will be an official sport in the 2024 Olympics.', 2, 1);
INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (59,0,'What team does Erling Haaland play for? ', 1, 1);

INSERT INTO public.quiztest_question(
	id, "typeOfQ", title, difficulty, quiz_id)
	VALUES (60,0,'What is Usain Bolt’s middle name?', 3, 1);
